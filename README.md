...
<h1>PicoClaw: Low-Footprint AI Teammate Runtime in Go</h1>

<h3>Edge-Friendly Runtime · Private AI Teammates · Go Native</h3>
  <p>
...
**PicoClaw** started as an ultra-lightweight personal AI assistant inspired by [NanoBot](https://github.com/HKUDS/nanobot). It has since evolved into a low-footprint, self-hosted runtime for private AI teammates, memory, and operator workflows, while keeping the Go-native and edge-friendly deployment story.

**The core runtime can still run on very small hardware.** The full launcher, teammate review surfaces, and operator cockpit experience are better on a modest SBC, mini PC, or VM.
...
## 🧭 What PicoClaw Is Today

PicoClaw is best understood as:

- a self-hosted AI runtime in Go
- a private launcher for review, approvals, and operations
- a teammate system for roles such as coder, reviewer, operator, and researcher
- a memory layer with shared and teammate-local scopes
- a coordination surface for tools like Codex CLI and Claude Code
...
🪶 **Low-footprint core runtime**: Headless gateway and agent flows still fit SBC and edge deployments.*

💰 **Minimal cost**: Efficient enough to run on $10 hardware — 98% cheaper than a Mac mini.

⚡️ **Fast startup**: The Go-native runtime still boots quickly even on constrained devices.
...
_*For the core runtime. The full launcher/UI workflow requires more memory and is better suited to a modest SBC, mini PC, or VM. Boot speed comparison based on 0.8GHz single-core benchmarks (see table below)._
